  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-6 pt-4">
      <div>
        ...
        <p className="text-gray-600 mt-1">Strategic insights and business intelligence for informed decision-making</p>
      </div>
      <div className="space-y-8">
        {/* New TCH CRM Command Center Banner */}
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg p-4 flex items-center justify-between">
          <div>
            <h3 className="font-semibold">New: TCH CRM Command Center Available</h3>
            <p className="text-sm opacity-90 mt-1">
              Access real-time team performance metrics and financial analytics
            </p>
          </div>
          <div className="flex gap-2">
            ...
            <a
              ...
              className="bg-white/20 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-white/30 transition-colors"
            >
