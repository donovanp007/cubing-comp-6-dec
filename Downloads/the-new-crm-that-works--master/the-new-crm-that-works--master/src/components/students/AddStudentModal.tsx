...
export default function AddStudentModal({
  ...
  const handleAddSchool = () => {
    if (newSchoolName.trim() && onAddSchool) {
      const newSchool = onAddSchool(newSchoolName.trim())
      setLocalSchools(prev => [...prev, newSchool].sort((a, b) => a.name.localeCompare(b.name)))
  ...
  const onSubmit = async (data: StudentFormData) => {
    ...
    try {
      ...
      // Convert form data to StudentInsert format with smart defaults
      const studentData: StudentInsert = {
        first_name: data.first_name,
        last_name: data.last_name || '', // Allow empty last name
        school_id: data.school_id || null, // Allow null school
        grade: data.grade,
        parent_name: data.parent_name || null, // Allow null parent info
        ...
        certificate_given: data.certificate_given,
        cube_received: data.cube_received,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new student to the cubing program. Only first name is required - parent information is now optional and can be added later.
          </DialogDescription>
        </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={(value) => field.onChange(parseInt(value))} value={field.value?.toString() || "5"}>
                      <FormControl>
                        <SelectTrigger>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Any notes about parent communication, preferences, etc. (optional)"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value || "Beginner Cubing"}>
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value || "outstanding"}>
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
